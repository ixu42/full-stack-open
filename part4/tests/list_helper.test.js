...
describe('total likes', () => {
  ...
  test('when list has only one blog equals the likes of that', () => {
    assert.strictEqual(listHelper.totalLikes(single_blog), 7)
  })

  test('of a bigger list is calculated right', () => {
    assert.strictEqual(listHelper.totalLikes(multiple_blogs), 36)
  })
})
...
describe('favorite blog', () => {
  ...
  test('of single blog list is that blog', () => {
    const result = listHelper.favoriteBlog(single_blog)
...
describe('most blogs', () => {
  ...
  test('of single blog list is that author', () => {
    const result = listHelper.mostBlogs(single_blog)
    assert.deepStrictEqual(result, { author: "Michael Chan", blogs: 1 })
  })

  test('of multiple blogs is the author with most blogs', () => {  
...
describe('most likes', () => {
  ...
  test('of single blog list is that author', () => {
    const result = listHelper.mostLikes(single_blog)
    assert.deepStrictEqual(result, { author: "Michael Chan", likes: 7 })
  })

  test('of multiple blogs is the author with most likes', () => {  
